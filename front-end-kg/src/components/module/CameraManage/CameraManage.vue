<template>
  <div
    class="content-wrapper camera-manage-wrapper"
    ref="viewbox"
  >
    <!--头部导航-->
    ...
    >
      <div class="cameraheader" v-if="!isCloudGateway">
        <div class="tab-wrapper">
          <div class="active">摄像机管理</div>
          <div
            @click="
              $router.push({ path: '/deviceGroupManage' })
            "
          >
            摄像机组管理
          </div>
        ...
        <!-- <el-button type="primary" plain class="query">图像管理</el-button> -->
        <el-button
          type="primary"
          plain
          class="query"
        ...
        <el-dropdown split-button type="primary">
          ...
          >
            ...
            <el-dropdown-item>
              <div
                @click="mutilStatusAll('addDeviceGroup')"
              >
          ...
          >
            <el-form :inline="true">
              <el-form-item
                ...
                prop="regionCode"
                v-if="
                  uinfo.regionCode == 100000 ? true : false
                "
              >
                <el-select
              ...
              <el-form-item label="所属路线:">
                <el-select
                  ...
                  filterable
                  :class="
                    filters.roadCode ? 'input-selected' : ''
                  "
                  placeholder="路线"
                  clearable
                  style="width:100px"
      ...
      <!-- 网关公用表头 -->
      <div
        class="table-control cloud-gateway-wrapper"
        v-if="isCloudGateway"
      >
        <div class="cloud-gateway-header">
          <div class="title">
            ...
            <span style="padding-left:20px;">{{
              gatewayInfo.transcodingName
            }}</span>
          </div>
          <div class="set-time">
            {{ gatewayInfo.createDate }}
          </div>
        </div>
            ...
            >
              <div class="grid-content">
                <div class="row-content">
                  ...
                  <div class="centent">
                    {{ gatewayInfo.regionName }}
                  </div>
                </div>
                <div class="row-content">
                  <div class="title">最大接入数：</div>
                  <div class="centent">
                    {{ gatewayInfo.channelNum }}
                  </div>
                </div>
              </div>
            </el-col>
            ...
            <el-col :span="8">
              <div class="grid-content">
                <div class="row-content">
                  ...
                  <!-- <el-tooltip :content="gatewayInfo.roadNames" style="display: inline-block;width: calc(100% - 50px);vertical-align: bottom;"> -->
                  <div class="centent">
                    {{ gatewayInfo.roadNames }}
                  </div>
                  <!-- </el-tooltip> -->
                </div>
              </div>
        ...
        <div class="cloud-gateway-camera-info">
          <div class="cloud-gateway-title">
            归属摄像机信息
          </div>
          <div
            class="cloud-gateway-row"
            style="display: flex"
          >
            <div style="width:85%">
              <el-form>
            ...
            <div>
              ...
              <el-dropdown split-button type="primary">
                ...
                >
                  ...
                  <el-dropdown-item>
                    <div
                      @click="mutilStatusAll('display-1')"
                    >
                      <span class="iconTips bf-icon"></span>
                      <span>显示</span>
                    </div>
                  ...
                  <el-dropdown-item>
                    <div
                      @click="mutilStatusAll('display-0')"
                    >
                      <span class="iconTips tz-icon"></span>
                      <span>隐藏</span>
                    </div>
                  ...
                  <el-dropdown-item>
                    <div
                      @click="
                        mutilStatusAll('addDeviceGroup')
                      "
                    >
                      <span
                        class="iconTips tjsb-icon"
                      ></span>
                      <span>添加到摄像机组</span>
                    </div>
                  </el-dropdown-item>
      ...
      >
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div
                style="float: left;padding-right: 5px;line-height: 18px;"
              >
          ...
          >
            <template slot-scope="scope">
              <div @click="handCameraStatus(scope.row)">
                <span
                  :style="getStyles(scope.row.onlineStatus)"
                ></span>
                <span
          ...
          <el-table-column
            v-if="
              cameraColData[7].istrue && !isCloudGateway
            "
          ...
          >
            ...
            <template slot-scope="scope">
              <div>
                <img
                  v-if="
                    scope.row.streamControlStatus === '1'
                  "
          ...
          <el-table-column
            v-if="
              cameraColData[12].istrue && !isCloudGateway
            "
            ...
            <template slot-scope="scope">
              ...
              <div>
                ...
                <i
                  style="cursor:pointer"
                  v-if="
                    scope.row.ptzControlStatus === 1 &&
                      scope.row.ptzStatus === 1
                  "
                  class="icon-control"
          ...
          <template slot="header" slot-scope="scope">
            ...
            <template slot-scope="scope">
              <el-tooltip
                class="item"
                effect="dark"
                :content="scope.row.openStatus === '1' ? '是' : '否'"
                placement="top"
              >
                <div
                  style="cursor:pointer"
                  @click="toggleOpenStatus(scope.row.openStatus === '1' ? '0' : '1', scope.row.openStatus === '1' ? '否' : '是', scope.row)"
                >
                <img
                    v-if="scope.row.openStatus === '1'"
                    src="../../../assets/images/icon/success.png"
    ...
    <div class="addGroupDialog">
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button
            @click="appendDeiveGroupDialogVisible = false"
            >取 消</el-button
          >
          <el-button
            type="primary"
            @click="appendDeiveGroup()"
            >确 定</el-button
          >
        </div>
      </el-dialog>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="setPriorityDialogVisible = false"
          >取 消</el-button
        >
        <el-button type="primary" @click="setBtn"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      <el-form :model="addDeiveGroupFrom">
        ...
        <el-form-item label>
          <el-input
            v-model="addDeiveGroupFrom.groupName"
            placeholder="请输入内容"
          ></el-input>
        </el-form-item>
        <el-form-item label>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          @click="addDeiveGroupDialogVisible = false"
          >取 消</el-button
        >
    ...
    >
      <div class="camera-result-dialog">
        ...
        <span
          >成功{{ succeedList.length }}路，失败{{
            errorList.length
          }}路</span
        >
        <p
          @click="
            ;(cameraReportDetailsDialogVisible = true),
              (cameraResultDialogVisible = false)
          "
        >
          查看详情
        </p>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
          type="primary"
          @click="cameraResultDialogVisible = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      <template slot="title">
        <div class="camera-report-title">
          <span class="dialog-status"
            >共{{ reportTotal }}条数据</span
          >
    ...
    >
      <template slot="title">
        <div>
          ...
          <span class="dialog-transfer"
            >当前视频传输状态</span
          >
          <span
            :style="
              getStyles(cameraTransferInfo.cameraStatus)
            "
          ></span>
    ...
    >
      <div style="height:100%;">
        <TrafficAmap
          ref="lonAndlatMap"
          :cameraNumber="lonAndlatOperation.cameraNum"
        ></TrafficAmap>
      </div>
    </el-dialog>
    <el-dialog
    ...
    >
      <div style="height: 100%">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button @click="customColVisible = false"
            >取 消</el-button
          >
          <el-button
            type="primary"
            @click="confirmCustomCols()"
            >确 定</el-button
          >
        </div>
      </div>
...
import CameraPlayDialog from './CameraPlayDialog'
import cameraDetail from '../equipment/cameraDetail'
import cloudPriority from './cloudPriority'
import cameraTransfer from './cameraTransfer'
import cameraReportDetails from './cameraReportDetails'
import qs from 'qs'
export default {
  components: {
    CameraPlayDialog,
  ...
  data() {
    return {
      ...
      tableVisible: true,
      showCancel: false,
      IsSuppPlatform: JSON.parse(
        localStorage.getItem('IsSuppPlatform')
      ) // 判断是否需要上报
    }
  },
  created() {
  ...
  methods: {
    ...
    query() {
      ...
      if (
        this.filters.openStatus &&
        this.filters.openStatus1
      ) {
        openStatus = null
      } else {
      ...
      if (
        this.filters.displayStatus &&
        this.filters.displayStatus1
      ) {
        displayStatus = null
      } else {
      ...
      this.$api
        ...
        .then(res => {
          ...
          this.tableList = _.map(res.data, it => {
            ...
            return {
              ...
              classifyCode: classify
                ? classify.codeName
                : '',
              derectionCode: derectionCode
                ? derectionCode.codeName
                : ''
            }
          })
          ...
          console.log('整完的 tableList', this.tableList)
          //load.close();
        })
        .catch(error => {
          //load.close();
    ...
    togglePtzStatus(row) {
      ...
      this.$confirm('提示', {
        ...
        .then(() => {
          this.$api.authUpdateControl(obj).then(res => {
            if (res.code === 200) {
    ...
    deleteCamera() {
      ...
      this.$confirm('确定删除摄像机?', '提示', {
        ...
        var cams = []
        for (
          var i = 0, len = this.multipleSelection.length;
          i < len;
          i++
        ) {
    ...
    cameraReportConsequenceDetails(req) {
      ...
      if (req.reportMsg !== null) {
        ...
        this.succeedList = req.reportMsg.filter(
          item =>
          ...
          for (let i = 0; i < nlen; i++) {
            for (let j = 0; j < olen; j++) {
              if (
                ...
                cameraList[j].openStatus =
                  itemList[i].openStatus
                cameraList[j].playStatus =
                  itemList[i].playStatus
                break
              }
            }
          }
     ...
     */
    handlePlay(obj) {
      console.log('cameraManage.vue handleplay obj', obj)
    ...
    gatelonAndlat(obj) {
      ...
      this.$api.getPositionLatNew(latObj).then(res => {
        if (res.code == 200) {
          ...
          this.$nextTick(() => {
            this.$refs.lonAndlatMap.cameraViewPoint(
              list,
              obj.cameraName
            )
          })
