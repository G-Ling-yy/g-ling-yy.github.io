  ...
  <div>
    <el-form class="demo-form-inline">
      ...
      <!-- <div :class="isAllHeight % 2 != 0 ? 'common-search-all-h' : 'search-wrapper'"> -->
          ...
          <el-form-item label="日期:" v-if="reporyType == 'day' ? true : false">
      ...
      <el-form-item v-if="reporyType == 'day' ? true : false">
    ...
    <div class="textView-wrapper">
      ...
      <el-card class="box-card">
        ...
        <div class="table-wrapper">
          ...
          <div class="tablebox_body" v-if="false">
            <el-table 
  ...
  methods: {
    ...
    getReportList() {
      ...
      let obj = {
        ...
        data: {
          ...
          // reportId:this.searchInfo.selectDate,
          reportType: 'S',
    ...
    handleSearch() {
      ...
      if (Array.isArray(this.searchInfo.selectDate)) {
        ...
        if (this.reporyType === 'week') {
          let last_monday = moment(moment(this.postData.startDate) + 3600 * 1000 * 24 * 6).format('YYYY-MM-DD');
    ...
    queryCameraAccessList () {
      console.log(21324)
        ...
        var _this = this;
        _this.listData = [];
        this.$api.queryCameraAccessList(obj).then((res) => {
          if (res.code == 200) {
            var list = res.data;
    ...
    getSelectWeekList () {
        ...
        this.$api.getSelectWeekList(obj).then((res) => {
          if (res.code == 200) {
    ...
    parseOrgData(orgs, level, p) {
      ...
      var size = 0
      orgs.forEach((org, i) => {
        if (org.organizationType == undefined || parseInt(org.organizationType) <= 10) {
          var param = {};
          var s = 0;
          for (var j in p) {
            param[j] = p[j];
