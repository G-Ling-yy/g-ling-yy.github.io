                        ...
                        <el-tab-pane label="未选" name="total">
                            ...
                            <div style="text-align:center;">
                                ...
                                <el-button 
                                    ...
                                    @click="chooseCamera">选择</el-button>
                            </div>
                        </el-tab-pane>
                        <el-tab-pane :label="'已选' + checkedOptions.total" name="checked">
                            ...
                            <div style="text-align:center;">
                                ...
                                <el-button 
                                    ...
                                    type="primary" 
                                    style="margin-right: 4px;"
                                    @click="cancelChecked">取消选择</el-button>
                            </div>
                        </el-tab-pane>
                    </el-tabs>
...
export default {
    ...
    created(){
        Promise.all([this.loadClassify(), this.loadArea(), this.queryRoadList()]).then(res => {
    ...
    methods: {
      ...
      console.log(params,"sdadas")
            ...
            this.$api.chooseCameraIds(params).then(res => {
                if(res.code !== 200){
                    this.$message({
                        type: 'error',
        ...
        cancelChecked(){
            ...
            this.$api.cancelChooseCameraIds(params).then(res => {
                if(res.code !== 200){
                    this.$message({
                        type: 'error',
