        ...
        >
            ...
            <template v-for="(item, index) in innerColumns">
                ...
                <el-table-column
                    ...
                    :key="index"
                ></el-table-column>
                 <el-table-column v-else-if="item.type === 'operation'" :key="index" :prop="item.id" :label="item.name" :align="item.align?item.align:'center'" :width="item.width">
...
export default {
    ...
    mounted() {
        ...
        console.log("columns",this.innerColumns)
    },
