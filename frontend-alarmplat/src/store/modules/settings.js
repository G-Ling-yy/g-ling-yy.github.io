...
const theme = getLocalStorage('vue-admin-theme')
const { collapse } = getLocalStorage('vue-admin-collapse')
const { language } = getLocalStorage('vue-admin-language')
const toggleBoolean = key => {
  return typeof theme[key] !== 'undefined'
    ? theme[key]
    : key
}
