/**
 * @description   深色主题地图相关配置
 * @author       刘晖(liuh@microvideo.cn)
 * @date         2021/11/18 14:32
 */


const darkLayerImgConfig = [
  {
    type: 'lk',
    img: [require('../../static/images/map-layer/dark/img-lk.png'), require('../../static/images/map-layer/dark/img-lk-active.png')],
    color: '#ff0000',
    width: 6,
  }, {
    type: 'sxt',
    img: [require('../../static/images/map-layer/dark/img-sxt.png'), require('../../static/images/map-layer/dark/img-sxt-active.png')],
    icon: [
    ...
    type: 'qbb',
    img: [require('../../static/images/map-layer/dark/img-qbb.png'), require('../../static/images/map-layer/dark/img-qbb-active.png')],
    icon: [
    ...
    type: 'jdd',
    img: [require('../../static/images/map-layer/dark/img-jdd.png'), require('../../static/images/map-layer/dark/img-jdd-active.png')],
    icon: [
    ...
    type: 'dlsj',
    img: [require('../../static/images/map-layer/dark/img-dlsj.png'), require('../../static/images/map-layer/dark/img-dlsj-active.png')],
    icon: [
      { name: 'icon-gs-jdd', url: require('../../static/images/map-icon/dark/gs/icon-jdd.png') },
      { name: 'icon-gs-jdd-active', url: require('../../static/images/map-icon/dark/gs/icon-jdd-active.png') },
      { name: 'icon-gl-jdd', url: require('../../static/images/map-icon/dark/gl/icon-jdd.png') },
    ...
    type: 'jycl',
    img: [require('../../static/images/map-layer/dark/img-jycl.png'), require('../../static/images/map-layer/dark/img-jycl.png')],
    icon: [
    ...
    type: 'jc',
    img: [require('../../static/images/map-layer/dark/img-jc.png'), require('../../static/images/map-layer/dark/img-jc.png')],
    icon: [
    ...
    type: 'zfc',
    img: [require('../../static/images/map-layer/dark/img-zfc.png'), require('../../static/images/map-layer/dark/img-zfc.png')],
    icon: [
    ...
    type: 'lytc',
    img: [require('../../static/images/map-layer/dark/img-lyyc.png'), require('../../static/images/map-layer/dark/img-lyyc-active.png')],
    icon: [
    ...
    type: 'qxd',
    img: [require('../../static/images/map-layer/dark/img-qxd.png'), require('../../static/images/map-layer/dark/img-qxd-active.png')],
    icon: [
    ...
    type: 'gq',
    img: [require('../../static/images/map-layer/dark/img-gq.png'), require('../../static/images/map-layer/dark/img-gq-active.png')],
    icon: [
    ...
    type: 'fwq',
    img: [require('../../static/images/map-layer/dark/img-fwq.png'), require('../../static/images/map-layer/dark/img-fwq-active.png')],
    icon: [
    ...
    type: 'sfz',
    img: [require('../../static/images/map-layer/dark/img-sfz.png'), require('../../static/images/map-layer/dark/img-sfz-active.png')],
    icon: [
    ...
    type: 'qd',
    img: [require('../../static/images/map-layer/dark/img-qd.png'), require('../../static/images/map-layer/dark/img-qd-active.png')],
    icon: [
    ...
    type: 'etc',
    img: [require('../../static/images/map-layer/dark/img-etc.png'), require('../../static/images/map-layer/dark/img-etc-active.png')],
    icon: [
    ...
    type: 'tcq',
    img: [require('../../static/images/map-layer/dark/img-tcq.png'), require('../../static/images/map-layer/dark/img-tcq-active.png')],
    icon: [
    ...
    type: 'sn',
    img: [require('../../static/images/map-layer/dark/img-sn.png'), require('../../static/images/map-layer/dark/img-sn-active.png')],
    icon: [
    ...
    type: 'ql',
    img: [require('../../static/images/map-layer/dark/img-ql.png'), require('../../static/images/map-layer/dark/img-ql-active.png')],
    icon: [
    ...
    type: 'sd',
    img: [require('../../static/images/map-layer/dark/img-sd.png'), require('../../static/images/map-layer/dark/img-sd-active.png')],
    icon: [
    ...
    type: 'lx',
    img: [require('../../static/images/map-layer/dark/img-lx.png'), require('../../static/images/map-layer/dark/img-lx-active.png')],
    color: '#b0ff00',
    width: 2,
  }, {
    type: 'zh',
    img: [require('../../static/images/map-layer/dark/img-zh.png'), require('../../static/images/map-layer/dark/img-zh-active.png')],
    icon: [
...
const darkConfig = {
  theme: 'dark',
  mapConfig: {
    mapStyle: 'amap://styles/71422d8cf6d8e6228fc5283f83817efa',
  },
  businessConfig: darkLayerImgConfig,
  businessStyleConfig: {
    iconClose: require('../../static/images/map-layer/close-dark.png'),
    background: '#000000'
  }
};
